...
const NavBar = () => {
  ...
  return (
    <nav className="flex flex-col md:flex-row px-4 justify-between items-center">
      ...
      <div
        className={`flex p-2 w-full md:flex-row flex-col transition-all duration-300 ease-in-out
  ...
  ${isNavOpen
    ...
    : "overflow-hidden max-h-0 opacity-0 md:pointer-events-auto pointer-events-none"
      ...
      >
        {/* Center Nav Links */}
        <div className="center md:mb-0 mb-7 md:ms-[400px] md:me-[380px]">
