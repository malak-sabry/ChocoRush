...
function Login() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const fallback = role === "admin" ? "/admin/products" : "/"
  ...
  return (
    <Layout>
      <div className="flex justify-center items-center min-h-screen px-4">
        <div className="w-full h-120 flex flex-col justify-center max-w-md bg-[#FCF0E6] p-8 rounded-xl shadow-lg border border-[#c9b49a]">
